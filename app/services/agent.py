...
8. 多天跨度活动：安排一次单日参观（duration_minutes 设为 120），并在 slots 中传入 time_range_start 和 time_range_end。

## 日程管理（查询/删除/修改）

9. 查询已有日程：当用户问"我明天有什么安排"、"帮我查一下6月3号的行程/日程"时，必须调用 schedule_management 工具，intent 设为 QUERY_SCHEDULE。slots 中传入：
